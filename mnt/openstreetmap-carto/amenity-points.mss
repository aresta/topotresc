...
#amenity-points {
  ...
  [feature = 'highway_elevator'][zoom >= 17] {
    [access = null],
    [access = 'yes'] {
  ...
  [feature = 'amenity_shower'][zoom >= 17] {
  ...
  [feature = 'man_made_mast']["tower:type" = 'lighting'][zoom >= 17]   {
    [zoom >= 14][height >= 160],
    [zoom >= 15][height >= 80],
    [zoom >= 16][height >= 40],
    [zoom >= 17][height >= 20],
  ...
  [feature = 'man_made_tower']["tower:type" = 'lighting'][zoom >= 17],
  [feature = 'man_made_tower']["tower:type" = 'bell_tower'][zoom >= 17],
  [feature = 'man_made_tower']["tower:type" = 'watchtower'][zoom >= 17],
  ...
  [feature = 'historic_memorial'][memorial = 'bust'][zoom >= 17],
  [feature = 'historic_memorial'][memorial = 'stele'][zoom >= 17],
  [feature = 'historic_memorial'][memorial = 'stone'][zoom >= 17],
  ...
  [feature = 'shop'] {
    ...
    [shop = 'charity'][zoom >= 17] {
      marker-file: url('symbols/shop/charity.svg');
    }

    [shop = 'chemist'][zoom >= 17] {
    ...
    [shop = 'stationery'][zoom >= 17] {
      marker-file: url('symbols/shop/stationery.svg');
    }

    [shop = 'tobacco'][zoom >= 17] {
  ...
  [feature = 'natural_peak']{
      [zoom < 12][prominence >= 400],
      [zoom >= 12][zoom < 13][prominence >= 200],
      [zoom >= 13][zoom < 15][prominence >= 100],
      [zoom >= 15] {
  ...
  [feature = 'natural_peak']{
    ...
    [zoom >= 13][zoom < 15][prominence >= 100],
    [zoom >= 15] {
      // text-name: [name] + " p:" + [prominence];
      text-name: "[name]";
      text-size: @standard-font-size;
      text-wrap-width: @standard-wrap-width;
      text-line-spacing: @standard-line-spacing-size;
      text-fill: darken(@landform-color, 40%);
...
.amenity-low-priority {
  ...
  [feature = 'barrier_gate'] {
    marker-file: url('symbols/barrier/barrier.svg');
    marker-fill: #690101;
    marker-clip: false;
    marker-width: 13;
    marker-allow-overlap: true;
  ...
  [feature = 'leisure_track'] {
    [zoom >= 16] {
      [zoom >= 17] {
        ...
        [zoom >= 17] { bridgecasing/line-width: 2.5; }
