...
@primary-width-z15:              9.5;
@primary-link-width-z15:        7.8;
@secondary-width-z15:             7.8;
@secondary-link-width-z15:        7;
@tertiary-width-z15:              7.2;
  ...
  ::casing {
    [zoom >= 12] {
      [feature = 'highway_motorway'] {
        ...
        #tunnels {
          line-width: 0; // workaround to avoid adding the line
          line-opacity: 0;
          // line-dasharray: 4,2;
        }
        #bridges {
    ...
    [feature = 'highway_path'][horse = 'designated'] {
      ...
      [zoom >= 15] {
        ...
        #tunnels {
          ...
          line/line-cap: round;
          line/line-opacity: @tunnel-opacity;
        }
      }
    }
