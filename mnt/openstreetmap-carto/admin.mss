...
#admin-mid-zoom[zoom >= 11][zoom < 13],
#admin-high-zoom[zoom >= 13][zoom <= 15] {
...
#admin-text[zoom >= 11][zoom <= 15][way_pixels >= 48000] {
...
#protected-areas-text[zoom >= 13][zoom <= 15][way_pixels > 192000] {
  text-name: "[name]";
  text-face-name: @book-fonts;
  text-fill: green;
